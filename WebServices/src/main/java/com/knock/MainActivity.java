...
public class MainActivity extends Activity {
    ...
    private static final String LOCALIZACION = "192.168.1.64:8080";
    ...
    private static final String METHOD_NAME = "dameFunciones";
        // NAME SPACE MÁS EL METODO A LLAMAR
    private static final String SOAP_ACTION = "hello_webservice/dameFunciones";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // MAPEO EL OBJETO
        soapEnvelope.addMapping(NAMESPACE,"Funcion", new Funcion().getClass());
        //
        ...
        try {
             ...
             * EN CASO DE LLAMAR UN ARRAY LIST DE UN OBJETO DEBES HACER EL PARSEADOR COMO EL EJEMPLO DE
             * MANDAR LLAMAR LA CLASE UtilesWs.envToComplex
             */
            ArrayList<Funcion> arregloFun = UtilesWS.envToCompex(soapEnvelope);

            EditText edText = (EditText) findViewById(R.id.propaganda);
            edText.setText("SEDE:: "+arregloFun.get(0).getSede()+"__PELICULA:: "+arregloFun.get(0).getTitulo()+"__HORA:: "+arregloFun.get(0).getHorario());
